...
//
//   - tracecheck: validate Go implementations (controllers, queues,
//     protocols) against specs by recording annotated actions under a
//     deterministic harness and checking the trace with TLC
